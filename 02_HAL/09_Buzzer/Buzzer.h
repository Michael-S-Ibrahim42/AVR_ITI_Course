...
#define _BUZZER_H
  ...
  typedef struct
  {
    u16*   Frequency;  /* Pointer the Tones buffer */
    u16    Size;    
    u16    Index;
    u16*   Duration; 
  ...
  */
  ...
  /* 
    ...
    Return     :   Error status of the fn, Error type is in "Buzzer.h" under "Error Type"
  */
  extern Buzzer_enuStatus_t Buzzer_enuSetTones(u8 Copy_u8BuzzerNum, Buzzer_strToneBuff_t* Copy_pstrToneBuff, u8 Copy_u8Periodicity);
  /* ///////////////////////////////////////////////////////////////////////////////// */
